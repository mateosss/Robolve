var CharacterSheet = Dialog.extend({
  ...
  ctor: function(hud, options, char) {
    ...
    options.height = options.height || "440px";
    ...
    this.statsSpeedLabel = new Text({text: "Speed", width: "100pw", y: "250px", bottom: "11px", hAlign: cc.TEXT_ALIGNMENT_LEFT, paddingHorizontal: "22px"});
    this.statsSpeedLabel.addTo(this.statsMain);
    this.statsSpeedValue = new Badge({bgImage: r.ui.panel_in_soft, text: "—", scale: 0.3, width: "128px", paddingVertical: "2px", height: "48px", x: "-128px + -22px", y: "250px", bottom: "16px", textFontSize: 80});
    this.statsSpeedValue.addTo(this.statsMain);
    this.statsBuildRangeLabel = new Text({text: "BuildRange", width: "100pw", y: "200px", bottom: "11px", hAlign: cc.TEXT_ALIGNMENT_LEFT, paddingHorizontal: "22px"});
    this.statsBuildRangeLabel.addTo(this.statsMain);
    this.statsBuildRangeValue = new Badge({bgImage: r.ui.panel_in_soft, text: "—", scale: 0.3, width: "128px", paddingVertical: "2px", height: "48px", x: "-128px + -22px", y: "200px", bottom: "16px", textFontSize: 80});
    this.statsBuildRangeValue.addTo(this.statsMain);
    this.statsBuildTimeLabel = new Text({text: "BuildTime", width: "100pw", y: "150px", bottom: "11px", hAlign: cc.TEXT_ALIGNMENT_LEFT, paddingHorizontal: "22px"});
    this.statsBuildTimeLabel.addTo(this.statsMain);
    this.statsBuildTimeValue = new Badge({bgImage: r.ui.panel_in_soft, text: "—", scale: 0.3, width: "128px", paddingVertical: "2px", height: "48px", x: "-128px + -22px", y: "150px", bottom: "16px", textFontSize: 80});
    this.statsBuildTimeValue.addTo(this.statsMain);
    this.statsAttackRangeLabel = new Text({text: "AttackRange", width: "100pw", y: "100px", bottom: "11px", hAlign: cc.TEXT_ALIGNMENT_LEFT, paddingHorizontal: "22px"});
    ...
    this.statsAttackSpeedLabel = new Text({text: "AttackSpeed", width: "100pw", y: "50px", bottom: "11px", hAlign: cc.TEXT_ALIGNMENT_LEFT, paddingHorizontal: "22px"});
